...
public class Assignment8 extends HttpServlet {
    ...
    static String topBodyHTML = "<body>\n" +
            ...
            "                        <form class=\"form\" method=\"post\" action=\"./assignment8\">\n" +
    ...
    static String endBodyHTML = "\n" +
            ...
            "                        <h3>Our group collaborated to complete assignment 8 to leverage RequestDispatcher for program forwarding to encapsulate parts of our web app. We all contributed to each other's parts. Deval contributed by copying the Java servlet for assignment 8 from our previous assignment 7." +
            "                            Alex contributed by modifying the doPost function to encapsulate the functionality of generating the truth table. Surya on method structure of both Assignment 8 and Assignment8_TruthTableGen to refactor for encapsulation of services. " +
            "                               Deval worked on utilizing the encapsulated service that generates the truth table by using forwarding in the doPost of Assignment8." +
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Use forwarding for truth table generation
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/assignment8_TruthTableGen");
